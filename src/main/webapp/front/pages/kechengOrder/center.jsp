					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kechengOrderUuidNumber" id="kechengOrderUuidNumber" lay-verify="required" placeholder="订单号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="kechengOrderTruePrice" id="kechengOrderTruePrice"  lay-verify="required|double"   placeholder="实付价格" autocomplete="off" class="layui-input">
							</div>
						</div>
