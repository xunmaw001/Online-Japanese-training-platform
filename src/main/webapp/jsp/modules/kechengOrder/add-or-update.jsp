    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑课程购买订单</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">课程购买订单管理</li>
                        <li class="breadcrumb-item active">编辑课程购买订单</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">课程购买订单信息</h3>
                                ...
                                <input id="yonghuId" name="yonghuId" type="hidden">
                                    <div class="form-group col-md-6 kechengOrderTruePriceDiv">
                                        ...
                                        <input style="width: 450px" id="kechengOrderTruePrice" name="kechengOrderTruePrice" class="form-control"
                                               onchange="kechengOrderTruePriceChickValue(this)" placeholder="实付价格">
                                    </div>
...
<script>
    ...
    function validform() {
        return $("#addOrUpdateForm").validate({
            ...
            messages: {
                kechengOrderUuidNumber: "订单号不能为空",
                kechengId: "课程不能为空",
                yonghuId: "用户不能为空",
                kechengOrderTruePrice: "实付价格不能为空",
            }
        }).form();
    }
