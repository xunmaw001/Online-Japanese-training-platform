        ...
        <div class="data-detail">
            ...
            <div class="layui-row">
                ...
                <div class="layui-col-md7" style="padding-left: 20px;">
                    ...
                    <div v-if="!yigoumaiFlag" class="detail-item" style="font-size: 20px">
                        还未购买课程哦,赶紧购买课程观看吧
                    </div>

                    <div v-if="!yigoumaiFlag" class="detail-item">
                            <div style="border: 0px solid #f2f2f2;margin-top: 20px;display: flex">
                ...
                <!-- 视频 -->
                <div  v-if="yigoumaiFlag" class="video-container">
                    <video style="width: 100%;" :src="detail.kechengVideo" controls="controls">
                        您的浏览器不支持视频播放
                    </video>
                </div>
                <%--<div style="font-size: 20px"  v-if="!yigoumaiFlag" class="video-container">
